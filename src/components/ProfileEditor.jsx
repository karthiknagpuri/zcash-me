...
const FIELD_CLASS =
  "w-full rounded-2xl border border-[#0a1126]/60 px-3 py-2 text-sm bg-transparent outline-none focus:border-[#f5c542] text-gray-800 placeholder-gray-400";
const LINK_FIELD_CLASS =
  "rounded-2xl border border-[#0a1126]/60 px-3 py-2 text-sm bg-transparent outline-none focus:border-[#f5c542] text-gray-800 placeholder-gray-400 appearance-none";
...
function DeleteActionButton({ onClick, disabled = false, isDeleted = false }) {
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      title={isDeleted ? "Reset" : "Delete"}
      className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors ${disabled
    ...
    <ModalPortal>
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div className="bg-white rounded-xl p-6 shadow-2xl max-w-sm w-full mx-4 text-center animate-fadeIn">
          <div className="mb-4 text-[#f5c542]">
        ...
        <div className="bg-white rounded-xl p-6 shadow-2xl max-w-sm w-full mx-4 text-center animate-fadeIn">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              type="button"
              onClick={onReauth}
              className="text-xs px-3 py-2 text-[#f5c542] border border-[#f5c542] rounded hover:bg-[#f5c542]/10"
            >
              Reauthenticate
            </button>
          </div>
    ...
    <div className="w-full flex justify-center bg-transparent text-left text-sm text-gray-800 overflow-visible">
      ...
      <div className="w-full max-w-xl bg-transparent overflow-hidden">
        ...
        <div className="mb-3 text-center">
          ...
          <div className="relative">
            <input
              ...
              className={`${FIELD_CLASS} font-mono pr-10`}
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2">
              <div className="relative inline-block">
                ...
                <div className="absolute fade-popup z-50 w-48 bg-white border border-gray-300 rounded-lg shadow-lg p-2 text-xs right-0 bottom-full mb-1">
                  Cannot change unverified address. Lost access? Create new profile.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`${FIELD_CLASS} pl-[5.5rem] pr-10`}
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2">
              <DeleteActionButton
        ...
        <div className="mb-3">
          ...
          <div className="relative">
            <textarea
              ...
              className={`${FIELD_CLASS} resize-none overflow-hidden pr-10 pb-6 text-left whitespace-pre-wrap break-words`}
            />
        ...
        <div className="mb-3">
          ...
          <div className="relative">
            <input
              ...
              className={`${FIELD_CLASS} font-mono pr-10 ${imageUrlValid
                ? "border-[#0a1126]/60 focus:border-[#f5c542]"
          ...
          <div className="mt-2">
            <button
              ...
              className="text-xs px-2 py-1 border border-[#f5c542] text-[#f5c542] rounded hover:bg-[#f5c542]/10"
            >
              Preview Avatar
            </button>
          </div>
          ...
          const linkActions = (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                {!canVerify ? (
                  <button
                    ...
                    className="text-xs px-2 py-1 border rounded text-[#f5c542] border-[#f5c542] hover:bg-[#f5c542]/10"
                  >
                    Authenticate
                  </button>
                ) : isVerified ? (
                  <div className="flex items-center gap-2">
                    ...
                    {showDiscordAvatarAction && (
                      <button
                        ...
                        className="text-xs px-2 py-1 text-[#f5c542] border border-[#f5c542] rounded hover:bg-[#f5c542]/10"
                      >
                        Use Discord Avatar
                      </button>
                    )}
                  ...
                  <button
                    ...
                    className={`text-xs px-2 py-1 border rounded ${isPending || (showRedirect && isOAuthLink)
                      ...
                      : "text-[#f5c542] border-[#f5c542] hover:bg-[#f5c542]/10"
                      }`}
                  >
              ...
              <button
                ...
                title="Delete link"
                className="w-6 h-6 rounded-full flex items-center justify-center text-red-600 bg-red-100 hover:bg-red-200 transition-colors"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
        ...
        <button
          type="button"
          onClick={addLink}
          className="text-sm font-semibold text-[#f5c542] hover:underline mt-1"
        >
          ＋ Add Link
        </button>
