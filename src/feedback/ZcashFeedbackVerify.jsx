    ...
    <>
      <div className="bg-transparent border-none shadow-none p-0 mt-1">
        ...
        <div className="text-left mb-2">
          <h3 className="font-semibold text-[#faf6ed] flex items-center gap-2">

            <span>
              Send from {" "}
              <span
                className="text-[#f5c542] cursor-pointer font-semibold"
        ...
        <div className="relative group w-full mb-1">
          ...
          >
            <span className="block -mx-3 -mt-2 mb-2 px-3 py-2 bg-[#2a2a2a] border-b border-[#f5c542]/30 rounded-t-xl text-center">
              <span className="block text-[12px] text-[#faf6ed]/80">
                {explainerText}
              </span>
            </span>
            <span className="block mt-2 text-[14px] text-[#faf6ed]">
        ...
        {showFooterHelp && (
          <p className="mx-1 mt-2 mb-3 text-sm text-[#faf6ed]/80 bg-[#1a1a1a] border border-[#f5c542]/30 rounded-lg p-3 leading-snug">
            We cannot send this message for you. After sending, expect to receive OTP within 24-hours. Then,
            {" "}
            <button
              type="button"
              onClick={() => setIsOtpOpen(true)}
              className="font-semibold text-[#f5c542] underline cursor-pointer"
            >
              enter your OTP
            </button>{" "}
        ...
        <div className="w-full flex items-center justify-center gap-2 text-center mt-1 mb-4">
          <p className="text-[12px] text-[#faf6ed]/60 italic m-0">
          ...
          <button
            ...
            className="text-[12px] font-semibold text-[#f5c542] underline m-0"
          >
        ...
        <div className="border-t border-[#f5c542]/30 mt-4 pt-4">
          {verifyUri && !error && (
